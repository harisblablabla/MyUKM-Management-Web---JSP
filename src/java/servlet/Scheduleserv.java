    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(status.equals("Update")){
                ...
                cc.setDay(request.getParameter("Day"));
                cc.setStartTime(request.getParameter("txtStartTime"));
                cc.setEndTime(request.getParameter("txtEndTime"));
                cc.setUKMPlaceID(Integer.parseInt(request.getParameter("txtUKMPlaceID")));
                cc.setUKMName(request.getParameter("txtUKMName"));
                cc.setScheduleID(request.getParameter("txtID"));
